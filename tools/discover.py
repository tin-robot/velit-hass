...
# BLE advertisement local names used by Velit devices.
# Source: manifest.json bluetooth matchers.
_VELIT_NAMES = {"VELIT", "VLIT", "D30"}
...
async def scan() -> None:
    ...
    print(f"Scanning {_SCAN_TIMEOUT:.0f}s for Velit devices ({', '.join(_VELIT_NAMES)})...")
